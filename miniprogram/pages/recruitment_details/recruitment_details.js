...
Page({
    ...
    dataProcessing(original) {
        ...
        original.start_date = tempYear + "年" + tempMonth + "月" + tempDay + "日";

        tempDateArr = original.update_date.split("/");
        tempYear = tempDateArr[0];
        tempMonth = tempDateArr[1];
        tempDay = tempDateArr[2];
        original.update_date = tempYear + "年" + tempMonth + "月" + tempDay + "日";
        ...
        wx.showModal({
            ...
            complete: (res) => {
                ...
                if (res.confirm) {
                    ...
                    tempAllData.href = "";
                    wx.reLaunch({
                        url: '/pages/index/index?datasss=' + JSON.stringify(tempAllData) + '&backable=true',
                    })
                }
            }
        })
